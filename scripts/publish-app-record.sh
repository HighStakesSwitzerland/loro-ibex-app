...
laconic -c $CONFIG_FILE registry name set --user-key "${CERC_REGISTRY_USER_KEY}" --bond-id ${CERC_REGISTRY_BOND_ID} "lrn://HighStakesSwitzerland/dns/ibex.pwa.highstakes.ch" "$AR_RECORD_ID"
